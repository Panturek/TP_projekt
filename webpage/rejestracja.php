    ...
    if(isset($_POST['email'])){
        ...
        try{
            ...
            if($conn->connect_errno!=0){
                ...
                $result=$conn->query("SELECT id FROM users WHERE email='$login'");
                ...
                if($alles_klar==true){
                    if($conn->query("INSERT INTO users VALUES(NULL, '$login', '$haslo_hash', '$email', now(), 0)"))
                    {
            ...
            echo '<span style="color: red; margin-left:20px;">Błąd serwera! Przepraszamy za niedogodności!</span>';
